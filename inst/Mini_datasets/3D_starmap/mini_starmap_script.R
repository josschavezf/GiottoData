...
spatFeatPlot3D(starmap_mini,
               expression_values = 'scaled',
               feats = "Pcp4",
               show_other_cells = F, axis_scale = "real",
               genes_high_color = 'red', genes_mid_color = 'white', genes_low_color = 'darkblue')
...
spatPlot(gobject = starmap_mini, show_network = T,
         network_color = 'gray', network_alpha = 0.3,
         spatial_network_name = 'Delaunay_network',
         point_size = 1.5, cell_color = 'leiden_clus',
...
spatFeatPlot2D(starmap_mini, expression_values = 'scaled',
...
spatFeatPlot2D(starmap_mini, expression_values = 'scaled',
             ...
             point_shape = 'border', point_border_stroke = 0.1,
             show_network = F, network_color = 'lightgrey', point_size = 1.5)
...
giottodata_repo = '/Users/george/Documents/GitHub/GiottoData/inst/Mini_datasets/'

saveGiotto(starmap_mini,
           foldername = '3DStarmapObject',
           #dir = paste0(system.file(package = 'GiottoData'),'/', 'Mini_datasets/'),
           dir = paste0(giottodata_repo, '/', '3D_starmap/'),
           overwrite = TRUE)
